...
class AddLanguageContainer extends Component {
  state = {
    LanguageName: '',
    LanguageCode: '',
  ...
  handleLabelSubmit = () => {
    ...
    this.props.addLanguageRequest(data, this.props.history);
  };
    ...
    return (
      <div style={{ width: 600, height: 'calc(100vh - 60px)', marginTop: 60 }}>
        ...
        <div style={styles.buttonWrapperStyle}>
          ...
          >
            <Add style={{ marginRight: 5 }} /> Create New Language
          </Button>
        </div>
      </div>
    );
...
const dispatchToProps = dispatch => ({
  ...
  addLanguageRequest: (data, history) =>
    dispatch(actions.addLanguageRequest(data, history))
});

export default connect(
  stateToProps,
  dispatchToProps
)(withStyles(rootStyles)(AddLanguageContainer));
