...
class PendingExperienceContainer extends Component {
  render() {
    const { pendingExperiences, totalPendingExperienceRecord } = this.props;
      ...
      <div>
        <div style={streamContentContainerStyle}>
          <div style={readyToStreamLabelWrapperStyle}>
            <span style={readyToStreamLabelStyle}>Total:</span>
            <span style={readyToStreamNumberStyle}>
          ...
          {pendingExperiences.length ? (
            <div style={readyToStreamWrapperStyle}>
              <InfiniteScroll
                pageStart={0}
                loadMore={() => this.props.handleLoadMoreExperience()}
                hasMore={
                  totalPendingExperienceRecord > pendingExperiences.length
                    ? true
                    : false
                }
                loader={null}
              ...
              >
                {pendingExperiences.map((experience, index) => (
                  <ReadyToStream
                    ...
                    handleGoLiveStream={() =>
                      this.props.handleGoLiveStream(experience)
                    }
                    handleClickOtherStreamHyper={() =>
                      this.props.handleClickOtherStreamHyper(experience)
                    }
                  />
                ))}
              </InfiniteScroll>
              ...
              <div style={pendingMsgWrapperStyle}>
                <div style={tableContainerStyle}>
                  <div style={tableWrapperStyle}>
                    <p style={pendingMsgStyle}>
                      There are no experience(s) found to be streamed. Click{' '}
                      <span
                        onClick={() => this.props.handleNavigateToExperience()}
                        style={clickHereLinkStyle}
                      >
                        here
                      </span>{' '}
...
export default PendingExperienceContainer;
